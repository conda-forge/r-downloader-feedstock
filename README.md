...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1091&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-downloader-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-downloader` can be installed with `conda`:
...
```
mamba install r-downloader
```

It is possible to list all of the versions of `r-downloader` available on your platform with `conda`:
...
```
mamba search r-downloader --channel conda-forge
```
...
mamba repoquery search r-downloader --channel conda-forge

# List packages depending on `r-downloader`:
mamba repoquery whoneeds r-downloader --channel conda-forge

# List dependencies of `r-downloader`:
mamba repoquery depends r-downloader --channel conda-forge
```
